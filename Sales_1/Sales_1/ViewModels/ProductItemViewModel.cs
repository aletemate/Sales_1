namespace Sales_1.ViewModels
{
    ...
    public class ProductItemViewModel : Product
    {
        ...
        private async void DeleteProduct()
        {
            ...
            var response = await this.apiService.Delete(url, prefix, controller, this.IdProduct);
            ...
            var deletedProduct = productsViewModel.MyProducts.Where(c => c.IdProduct == this.IdProduct).FirstOrDefault();
